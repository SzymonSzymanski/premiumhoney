...
function htmlPathTask(done) {
  src(config.app.html)
  .pipe(replace('img/','https://img.obi.pl/lp/lp-mc-template/img/'))
  .pipe(replace('css/','https://img.obi.pl/lp/lp-mc-template/css/'))
  .pipe(replace('js/','https://img.obi.pl/lp/lp-mc-template/js/'))
  .pipe(dest(config.dist.base))
...
exports.default = parallel(htmlTask, scssTask, imagesTask,fontsTask, cssTask, jsPathTask, watchFiles, liveReload);
exports.prod = series(cleanUp, parallel(jsTask, scssTask, imagesTask,fontsTask), htmlPathTask, cssPathTask, jsPathTask);
